 ...
 * 
 */
@Component("nz.co.senanque.pizza.R11")
public class R11
    implements Serializable, Rule
{
    ...
    public void evaluate(final RuleSession session, final ValidationObject object, final RuleContext ruleContext) {
        ...
        try {
            try {
                operations.checkTrue(operations.gt(0L, operations.count(((ListeningArray) proxyFieldorderItems.getValue()))));
            } catch (NotTrueException _x) {
                return ;
            }
            session.assign(ruleContext, operations.format(operations.count(((ListeningArray) proxyFieldorderItems.getValue())), "shopping.cart.status"), proxyFieldshoppingCartStatus);
    ...
    public String getRuleName() {
        return "nz.co.senanque.pizza.R11:shoppingcartsize";
    }

    public String getMessage(final RuleSession session, final ValidationObject object) {
        return session.getMessage("nz.co.senanque.pizza.R11", new Object[] { });
    }
