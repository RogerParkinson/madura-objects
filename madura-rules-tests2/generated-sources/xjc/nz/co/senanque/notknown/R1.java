 ...
 * 
 */
@Component("nz.co.senanque.notknown.R1")
public class R1
    implements Serializable, Rule
{
    ...
    public String getRuleName() {
        return "nz.co.senanque.notknown.R1:BMI";
    }

    public String getMessage(final RuleSession session, final ValidationObject object) {
        return session.getMessage("nz.co.senanque.notknown.R1", new Object[] { });
    }
    ...
    public FieldReference[] listeners() {
        return new FieldReference[] {new FieldReference("Customer", "Customer", "weight"), new FieldReference("Customer", "Customer", "height")};
    }
